...
// responseCollection
test('responseCollection.local.key(n) should return an Observable of the nth key in localStorage', function(
  t,
) {
  t.plan(1);
...
test('responseCollection.local.getItem(key) should return an Observable item in localStorage', function(
  t,
) {
  t.plan(3);
...
test('responseCollection.local.getItem(key) emit null if localStorage does not contain item for key', function(
  t,
) {
  t.plan(1);
...
test('responseCollection.session.key(n) should return an Observable of the nth key in sessionStorage', function(
  t,
) {
  t.plan(1);
...
test('responseCollection.session.getItem(key) should return an Observable item in sessionStorage', function(
  t,
) {
  t.plan(3);
...
test('responseCollection.local.getItem(key) emit null if sessionStorage does not contain item for key', function(
  t,
) {
  t.plan(1);
